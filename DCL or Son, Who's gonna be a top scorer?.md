...
#### 대외지표 : Att_Pen, Dist, Targ_90
 대내지표는 선수 개인능력과 직결되는 수치다. 대외지표는 포메이션, 전술적 역할 등과 연관지었다. 예를 들어, 도미닉 칼버트-르윈은 센터포워드로서 Dist가 윙어인 손흥민보다 높다. 이는 선수의 역량보다도 전술적 역할에 기인하는 요소다. 한편, SoT%는 슈팅 정확도만을 판단하는 것으로 포지션과는 무관하다. 
