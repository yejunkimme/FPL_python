...
### 도미닉 칼버트-르윈 : 받은 패스, 패널티 에이리어 내 터치 횟수, 유효슈팅에서 압도적인 수치 
 ...
 도미닉 칼버트-르윈의 특징은 받은 패스가 많아 패널티 에이리어 내에서 터치도 많았으며, 받은 패스의 상당 부분을 유효슈팅으로 연결지었다는 점이다. 득점에 이르기까지의 단계를 얼마나 착실히 수행했는지를 알려주는 Targ_90, Att_Pen_90, SoT/90에서 다른 선수를 크게 앞선다. 뱀포드도 해당 지표에서 높은 수치를 보이고 있지만, 칼버트-르윈에 비할 게 아니다. 
 
### 칼럼 윌슨 : 가성비를 위해 선택한다면, 상대편과 패널티킥 키커임을 고려해야
 칼럼 윌슨은 다른 두 선수와 전혀 다른 형태의 그래프를 가지고 있다. 타겟맨이 아닌만큼, 발밑 움직임을 통해 득점할 수 있는 선수인지를 평가하려 해도 패널티 에이리어 내에서의 터치 횟수가 가장 적다. 칼럼 윌슨에게 공급되는 패스 역시 가장 적은 편으로 오버퍼포먼스가 의심된다. 그럼에도 불구하고, 칼럼 윌슨이 공격수 가운데 가성비 TOP3로 꼽힌 것은 패널티킥 때문인 것으로 보인다. 
